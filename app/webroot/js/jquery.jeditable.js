...
/**
  ...
  *
  * @param String  options[update] Agrega MR: Donde se pondra lo que retorna el request AJAX, self por defecto, es el objeto editable, string con un slector jQuery (.class, #id, etc). **
  *             
  */
                    ...
                    if (false !== submit.apply(form, [settings, self])) { 
                      ...
                      if ($.isFunction(settings.target)) {
                          ...
                          $.post(settings.target, submitdata, function(str) {
                          	  if(settings.update == 'self') {
                          	  	$(self).html(str);
                          	  }
                          	  else if ($.isFunction(settings.update)) {
                              	$(settings.update.apply(self)).html(str);
                              }
                              else {
                              	$(settings.update).html(str);
                              }
                              //$('#desglose1_28').html(str);
                              self.editing = false;
                              callback.apply(self, [self.innerHTML, settings]);
                              /* TODO: this is not dry */                              
                              if (!$.trim($(self).html())) {

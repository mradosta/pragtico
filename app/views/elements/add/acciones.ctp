...
$eliminar = $appForm->button(__('Delete', true), array("class"=>"boton_rojo", "onclick"=>"document.getElementById('accion').value='delete';document.getElementById('form').action='../delete/#*ID*#/1';form.submit();"));

...
$usuario = $appForm->tag("span", $usuario['Usuario']['nombre_completo'] . $appForm->link($appForm->image('infos.gif'), array('controller' => 'infos', 'action' => 'index'), array("title"=>__("Informaciones / Alertas / Sugerencias", true))));

...
$cerrar = $appForm->link($appForm->image('cerrar.gif'), null, array("id"=>"bandaCerrarDesgloses", "title"=>__("Close all breakdowns", true)));
...
$iconos = $appForm->tag("p", $limpiar . $cerrar . $salir);

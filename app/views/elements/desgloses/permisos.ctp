...
$cellsOut[] = $appForm->tag("th", $operaciones . " Dueño: " . $registro['Usuario']['nombre_completo'], array("class"=>"izquierda"));
$cellsOut[] = $appForm->tag("td", __getImagen($appForm, $registro['puedeCambiarPermisos'], $registro['Usuario']['permisos']['leer'], "dl", $id), array("class"=>"centro"));
$cellsOut[] = $appForm->tag("td", __getImagen($appForm, $registro['puedeCambiarPermisos'], $registro['Usuario']['permisos']['escribir'], "de", $id), array("class"=>"centro"));
$cellsOut[] = $appForm->tag("td", __getImagen($appForm, $registro['puedeCambiarPermisos'], $registro['Usuario']['permisos']['eliminar'], "dd", $id), array("class"=>"centro"));
$out[] = $appForm->tag("tr", $cellsOut, $atributosFila);

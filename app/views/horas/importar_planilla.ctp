...
echo $this->renderElement("index/index", array("accionesExtra"=>$accionesExtra, "botonesExtra"=>array("opciones"=>array("botones"=>$botonesExtra)), "condiciones"=>$fieldset, "cuerpo"=>$cuerpo, "pie"=>$pie, "opcionesForm"=>array("enctype"=>"multipart/form-data", "action"=>"importar_planilla")));

...
echo $this->renderElement("index/index", array("botonesExtra"=>array("opciones"=>array("botones"=>$botonesExtra)), "condiciones"=>$fieldset, "opcionesTabla"=>$opcionesTabla, "opcionesForm"=>array("enctype"=>"multipart/form-data", "action"=>"importar_planilla")));

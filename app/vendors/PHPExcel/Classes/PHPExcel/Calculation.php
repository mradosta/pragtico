...
class PHPExcel_Calculation {
	...
	public function calculateCellValue(PHPExcel_Cell $pCell = null, $resetLog = true) {
		...
		return self::_unwrapResult($this->_calculateFormulaValue($pCell->getValue(), $pCell->getCoordinate(), $pCell));
...
//					echo 'Value is in cache<br />';
					$this->_writeDebug('Testing cache value');
...
//						echo 'Cache time is still valid<br />';
						$this->_writeDebug('Retrieving value from cache');
...
//						echo 'Cache has expired<br />';
						$this->_writeDebug('Cache value has expired');
	...
	private function _parseFormula($formula) {
		...
		$operatorPrecedence	= array('~' => 6,																//	Negation
									'%' => 5,																//	Percentage
									'^' => 4,																//	Exponentiation
...
//				echo 'Element is a Function argument separator<br />';
				...
				$d = $stack->pop();
				$stack->push($d['type'],++$d['value']);	// increment the argument count
